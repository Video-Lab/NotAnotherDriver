...
cap = cv2.VideoCapture('./Sample_Videos/forza_safe2.mp4') #VIDEO TO TRAIN, LOTS OF OPTIONS
...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        if(not ClassIndex==()):
            ...
            for ClassInd, conf in zip(ClassIndex.flatten(), confidence.flatten()): #going through stuffs in image, not too sure
                # cv2.rectangle(frame, bigbox, (255,0,0), 2)
